  ...
  return (
    <div className='w-96 h-screen'>
        ...
        <div className='flex flex-col overflow-y-auto h-[calc(100vh-100px)] mt-3 pb-20 pr-3'>
           <Notecard title={"Project of web"} content={"Loren is the key od loren is ithe helping sapce of the owrd inthe art of human world in here in siel self doubt in the world should be writeen her in case o fht higght os sate"} date={"10/12/2024"}/>
           <Notecard/>
           <Notecard/>
           <Notecard/>
           <Notecard/>
